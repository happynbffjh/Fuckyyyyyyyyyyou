...
MAX_SITE_PRODUCT_PRICE = 17.00
WORKER_COUNT = min(int(os.getenv("WORKER_COUNT", "30")), 25)
PROXY_VALIDATION_URL = "https://httpbin.org/ip"
PROXY_VALIDATION_TIMEOUT = 6
PROXY_VALIDATION_CONCURRENCY = int(os.getenv("PROXY_VALIDATION_CONCURRENCY", "30"))
